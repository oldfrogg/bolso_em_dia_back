...
- Desenvolver uma API para manipulação de um Banco de Dados que foi desenvolvido utilizando MySQL para o projeto 'Bolso em Dia';
- Familiarizar-se com Node.JS, MySQL, Sequelize, Express e afins;
